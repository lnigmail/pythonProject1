...
details_list= ["Leny shephard", 47, "lll@gmail.com", "0504444444"]
print("My name: " + str(details_list[0]) + "\nMy Age is: " + str(details_list[1]) +
"\nMy mail is: " + str(details_list[2]) + "\nMy phone is: " + str(details_list[3]))

IP_list=["1.1.1.1", "2.2.2.2"]
print("\nThis is 2IPs list: " + str(IP_list))

IP_list.append("3.3.3.3")
IP_list.append("4.4.4.4")
IP_list.append("5.5.5.5")
print("\nThis is 2IPs + 3IPs list: " + str(IP_list))

IP_list.pop(2)
print("\nThis is 3IPs list without the 3rd IP: " + str(IP_list))
